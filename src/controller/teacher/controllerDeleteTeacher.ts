...
import { serviceDeleteTeacher } from "../../services/teacher";

export const controllerDeleteTeacher = async (req: Request, res: Response): Promise<void> => {
    try {
        const { data, error } = await serviceDeleteTeacher(req.params.id);
